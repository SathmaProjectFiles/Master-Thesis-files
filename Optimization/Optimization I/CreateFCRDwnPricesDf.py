# -*- coding: utf-8 -*-
"""
Created on Mon May  6 22:18:51 2024

@author: Sathma Goonathilaka
"""
# ------------------------------------------------------------------------- #
# This function calculates the FCRD-Down prices for 1 MW of capacity for each hour 
...
def CreateFCRDwnPricesDf():
    ...
    for d in range(7): # To access each day of the week
        ...
        mean_price = merged_pivot_day.mean() # Calculating the mean of FCRD-Down prices...
