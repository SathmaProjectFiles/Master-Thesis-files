# -*- coding: utf-8 -*-
"""
Created on Thu May  9 19:16:00 2024

@author: Sathma Goonathilaka
"""
# ------------------------------------------------------------------------- #
# This function calculates and returns a list containing 7 dataframes,
# where each dataframe gives the hourly FCRD-Up prices of all days for 
...
def CreateFCRUpPricesDf():
    ...
    for d in range(7): # To access each day of the week
        ...
        # the hourly FCRD-Up prices of all days that are equal to d in Year 2022,
        # in a list.
...
#merged_pivot_week = CreateFCRUpPricesDf()
